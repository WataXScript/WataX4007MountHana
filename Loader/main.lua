...
local saveFile = "WataX_Key_hana.txt"
...
local function isKeyValid(k)
    local url = "https://raw.githubusercontent.com/WataXScript/WataX4007MountHana/main/Loader/eldl/"..k
...
if lastKey and isKeyValid(lastKey) then
    ...
    mainFrame.Visible = false
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataX4007MountHana/main/Loader/WataX.lua"))()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataX4007MountHana/main/Loader/mainmap337.lua"))()
end
